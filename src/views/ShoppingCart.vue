                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="cart-pic first-row">
                                                    <img src="img/cart-page/ootd-1a.png" />
                                                </td>
                                                <td class="cart-title first-row text-center">
                                                    <h5>Brownie Monday - T-Shirt</h5>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="cart-pic first-row">
                                                    <img src="img/cart-page/ootd-1b.png" />
                                                </td>
                                                <td class="cart-title first-row text-center">
                                                    <h5>Brownie Monday - Sweater</h5>
                                                </td>
                                                <td class="p-price first-row">$60.00</td>
                                                <td class="delete-item"><a href="#"><i class="material-icons">
                                                close
                                            ...
                                            <tr>
                                                <td class="cart-pic first-row">
                                                    <img src="img/cart-page/ootd-1c.png" />
                                                </td>
                                                <td class="cart-title first-row text-center">
                                                    <h5>Brownie Monday - Boots</h5>
                                                </td>
                                                <td class="p-price first-row">$60.00</td>
                                                <td class="delete-item"><a href="#"><i class="material-icons">
                                                close
                                            ...
                                            <tr>
                                                <td class="cart-pic first-row">
                                                    <img src="img/cart-page/ootd-1d.png" />
                                                </td>
                                                <td class="cart-title first-row text-center">
                                                    <h5>Brownie Monday - Skirt</h5>
                                                </td>
                                                <td class="p-price first-row">$60.00</td>
                                                <td class="delete-item"><a href="#"><i class="material-icons">
                                                close
